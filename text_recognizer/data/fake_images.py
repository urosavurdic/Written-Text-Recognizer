...
class FakeImageData(BaseDataModule):
    ...
    def __init__(self, args: argparse.Namespace = None):
        ...
        self.dim = (1, self.args.get("image_height", _IMAGE_LEN), self.args.get("image_width", _IMAGE_LEN))

        self.num_classes = self.args.get("num_classes", _NUM_CLASSES)
        self.output_dim = (self.num_classes, 1)
        self.char_to_idx = list(range(0, self.num_classes))
